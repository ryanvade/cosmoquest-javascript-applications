<template lang="html">
  <div class="reply-link">
    ...
    <div class="reply-link-menu" v-if="showCopy">
...
export default {
   ...
   */
  mounted() {
    this.url = window.location.origin + window.location.pathname + window.location.search + "#" + this.reply.id
  },
  methods: {
    /**
