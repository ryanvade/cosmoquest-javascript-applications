...
$(document).ready(() => {
  function moonData() {
    return $.ajax({
      dataType: "json",
      url: "/api/statistics/app/moon_mappers"
    });
  }
  ...
  function marsData() {
    return $.ajax({
      dataType: "json",
      url: "/api/statistics/app/mars_mappers"
    });
  }
  ...
  function mercuryData() {
    return $.ajax({
      dataType: "json",
      url: "/api/statistics/app/mercury_mappers"
    });
  }
  ...
  function vestaData() {
    return $.ajax({
      dataType: "json",
      url: "/api/statistics/app/vesta_mappers"
    });
  }
  ...
  $.getJSON('/api/statistics/app/moon_mappers', (moon_data) => {
    moon = moon_data;
    $.getJSON('/api/statistics/app/mars_mappers', (mars_data) => {
      mars = mars_data;
      $.getJSON('/api/statistics/app/mercury_mappers', (mercury_data) => {
        mercury = mercury_data;
        $.getJSON('/api/statistics/app/vesta_mappers', (vesta_data) => {
          vesta = vesta_data;
          $.getJSON('/api/statistics/app/image_detectives', (detectives_data) => {
